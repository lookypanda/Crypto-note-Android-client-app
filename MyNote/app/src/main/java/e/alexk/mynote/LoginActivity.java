...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    final public String URL=SessionConstants.URL;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mSettings.contains(APP_PREFERENCES_LOGIN)) {
            mEmailView.setText(mSettings.getString(APP_PREFERENCES_LOGIN, ""));
        }
        if(mSettings.contains(APP_PREFERENCES_PASS)) {
            mPasswordView.setText(mSettings.getString(APP_PREFERENCES_PASS, ""));
        }
    ...
    private boolean mylogin(final String login, final String password) {
        Snackbar.make(findViewById(R.id.login_root), "Loading. Be patient. ", Snackbar.LENGTH_LONG ).show();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (login_ok!=null) {
                            ...
                            SessionConstants.login=login;
                            SessionConstants.password=password;
    ...
    public void pass_recovery(View v){
        Intent intent = new Intent(getApplicationContext(), PassworRecoveryActivity.class);
        intent.putExtra("URL", URL);
        startActivity(intent);
    }
    public void reg_new(View v){
